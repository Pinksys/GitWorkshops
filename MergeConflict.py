...
print("Hello world, my name is Emily and my favorite programming language is Java ");

print("Hello world, my name is Ramin and my favorite programming language is definitely not C ");
